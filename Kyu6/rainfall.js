...
console.log('----------------------------------------------');
console.log('London data:', mean('London', data));
// console.log('London data1:', mean('London', data1));
console.log('----------------------------------------------');
console.log('Beijing data:', mean('Beijing', data));
// console.log('Beijing data1:', mean('Beijing', data1));
console.log('----------------------------------------------');
console.log('London data:', variance('London', data));
// console.log('London data1:', variance('London', data1));
console.log('----------------------------------------------');
console.log('Beijing data:', variance('Beijing', data));
// console.log('Beijing data1:', variance('Beijing', data1));
console.log('----------------------------------------------');
let match = data.match(new RegExp('London' + ':.*?(?:\n|$)', 'i'));
